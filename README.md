...
Top row: serial position curve, probability of first recall, temporal organization, and stop probability for data from Morton et al. (2013). Bottom row: data simulated using TCM.
